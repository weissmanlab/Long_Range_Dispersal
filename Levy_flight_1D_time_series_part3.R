...
dummy_vector <- dstable(x = distance, alpha = ALPHA , beta = 0, gamma = scale_parameter, delta = 0, pm = 0,log = FALSE,tol = 64*.Machine$double.eps, zeta.tol = NULL,subdivisions = 1000)
