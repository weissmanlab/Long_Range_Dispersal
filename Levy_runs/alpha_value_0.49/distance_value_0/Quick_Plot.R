...
library(ggpmisc)
#Final_Time <- 10000
CDF_table <-data.frame(read.table("CDF_of_coalescence_timesalpha_value_0.49distance_value_0000000rho_inverse_1e-05.txt"))
...
rho <- 100000
improper_norm <- 1.5*1/(2*pi*rho*(1- alpha)*D + 1)
print(improper_norm)
