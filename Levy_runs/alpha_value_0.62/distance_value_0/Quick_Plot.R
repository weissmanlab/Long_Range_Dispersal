...
library(ggpmisc)
#Final_Time <- 10000
CDF_table <-data.frame(read.table("CDF_of_coalescence_timesalpha_value_0.62distance_value_0000000rho_inverse_1e-05.txt"))
...
p <- ggplot(CDF_table, aes(V3, V5)) +
  geom_point() + geom_abline(intercept = -12.1, slope = (1-1/alpha), color="red", 
