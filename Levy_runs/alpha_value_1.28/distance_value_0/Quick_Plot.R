...
library(ggpmisc)
#Final_Time <- 10000
Log_Comp_CDF_table <-data.frame(read.table("Log_comp_CDF_of_coalescence_timesalpha_value_1.28distance_value_0000000rho_inverse_1.txt"))
...
p <- ggplot(Log_Comp_CDF_table, aes(V3, V5)) +
  geom_point() + geom_abline(intercept = -.2, slope = (1/alpha -1), color="red", 
