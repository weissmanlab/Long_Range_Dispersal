...
chdir(OUTPUTFILE_Child_Directory);
   ...
   current_position = initial_position; //fmod(initial_position, periodic_boundary);
...
//}
 ...
 current_position = current_position + signed_step_size; //fmod((current_position + signed_step_size),  periodic_boundary) ; 
