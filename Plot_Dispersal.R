...
{ 
  ...
  Stable_Dispersal_Data[index, 3] <- log(stable_pdf(dist , pars2))
  Gaussian_Dispersal_Data[index, 3] <- log(stable_pdf(dist , pars1))
  
  time <- 10
  pars1 <- c(alpha1, 0, scale_parameter*((time)^(1/alpha1)), 0)
  pars2 <- c(alpha2, 0, scale_parameter*((time)^(1/alpha2)), 0)
  Stable_Dispersal_Data[index, 4] <- log(stable_pdf(dist , pars2))
  Gaussian_Dispersal_Data[index, 4] <- log(stable_pdf(dist , pars1))
  
  time <- 100
  pars1 <- c(alpha1, 0, scale_parameter*((time)^(1/alpha1)), 0)
  pars2 <- c(alpha2, 0, scale_parameter*((time)^(1/alpha2)), 0)
  Stable_Dispersal_Data[index, 5] <- log(stable_pdf(dist , pars2))
  Gaussian_Dispersal_Data[index, 5] <- log(stable_pdf(dist , pars1))
  
  time <- 1000
  pars1 <- c(alpha1, 0, scale_parameter*((time)^(1/alpha1)), 0)
  pars2 <- c(alpha2, 0, scale_parameter*((time)^(1/alpha2)), 0)
  Stable_Dispersal_Data[index, 6] <- log(stable_pdf(dist , pars2))
  Gaussian_Dispersal_Data[index, 6] <- log(stable_pdf(dist , pars1))
